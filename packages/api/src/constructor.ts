...
import type { ProxmoxEngineOptions } from "./ProxmoxEngine.js";
import ProxmoxEngine from "./ProxmoxEngine.js";
import type { ApiRequestable } from "./proxy.js";
import { buildApiProxy } from "./proxy.js";

function isProxmoxEngine(
  val: ProxmoxEngineOptions | ApiRequestable,
): val is ApiRequestable {
...
export function proxmoxApi(
  ...
  if (isProxmoxEngine(options)) return buildApiProxy(options, "/api2/json");
  else return buildApiProxy(new ProxmoxEngine(options), "/api2/json");
}
