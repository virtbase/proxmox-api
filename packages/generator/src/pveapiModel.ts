...
export type PveParametersBaseSet =
  | PveParametersString
  | PveParametersArray
  | PveParametersObject
  | PveParametersInteger
  | PveParametersNumber;

export type PveCallParameters =
  | PveParametersBaseSet
  | PveParametersBoolean
  | PveCallParametersNull
  | PveParametersUndef
  | PveParametersAny;
